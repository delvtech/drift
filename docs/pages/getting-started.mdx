...
```ts twoslash
import { createDrift } from "@gud/drift";
import { viemAdapter } from "@gud/drift-viem"; // [!code hl]
...
Drift includes ABIs for common interfaces to get started quickly:

- [`erc20`](https://ethereum.org/en/developers/docs/standards/tokens/erc-20): Typical Token/Coin
- [`erc721`](https://ethereum.org/en/developers/docs/standards/tokens/erc-721): Non-Fungible Token (NFT)
- [`erc1155`](https://ethereum.org/en/developers/docs/standards/tokens/erc-1155): Multi-Token
- [`erc4626`](https://ethereum.org/en/developers/docs/standards/tokens/erc-4626): Tokenized Vault
- [`multicall3`](https://www.multicall3.com): Call Aggregator
