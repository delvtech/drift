...
[`DefaultAdapter`](https://github.com/ryangoree/drift/blob/main/packages/drift/src/adapter/DefaultAdapter.ts)
...
[issue](https://github.com/ryangoree/drift/issues) or start a
[discussion](https://github.com/ryangoree/drift/discussions) to discuss the
implementation.
...
```ts twoslash
// @noErrors
import { type Address, createDrift, DefaultAdapter } from "@gud/drift";
