...
// @filename: default.ts
// [!include ~/snippets/drift.ts]
import type { Hash } from "@gud/drift";
...
```ts twoslash
// [!include ~/snippets/drift.ts]
import { type Address, erc20, erc4626 } from "@gud/drift";
...
import type { Address, Bytes } from "@gud/drift";
...
```ts twoslash
// [!include ~/snippets/token.ts]
import type { Address } from "@gud/drift";
...
```ts twoslash
import type { Address, erc20, ReadWriteContract } from "@gud/drift";
...
// ---cut---
import type { FunctionName } from "@gud/drift";
