...
The `createMockDrift` function from `@gud/drift/testing` creates a mocked
...
import { type Address, type Drift, erc4626 } from "@gud/drift";
...
```ts twoslash
import { type Address, erc4626 } from "@gud/drift";
import type { MockDrift } from "@gud/drift/testing";
...
import assert from "node:assert";
import type { Address, erc4626 } from "@gud/drift";
import type { MockContract } from "@gud/drift/testing";
...
// @noErrors
import assert from "node:assert";
import { type Address, erc20.abi } from "@gud/drift";
import type { MockDrift } from "@gud/drift/testing";
declare const mockDrift: MockDrift;
// ---cut---
