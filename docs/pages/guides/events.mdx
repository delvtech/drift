...
const {
  ...
  data,             // Encoded event arguments
  transactionHash,  // Hash of the transaction this event was created from
  blockHash,        // Hash of the block the event was in
  blockNumber,      // Block number the event was in
...
```ts twoslash
import type { Address, Contract, erc20 } from "@gud/drift";
