...
be used with multiple providers without maintaining separate implementations or
rewrites.
...
Easy-to-use, type-safe [testing mocks](/guides/testing-strategies) that are
always in sync with your contracts. Test your business logic without network
calls.
...
[adapter](/guides/extending-drift#implementing-custom-adapters) and
[hook](/guides/extending-drift#using-hooks-for-middleware) systems.
